...
const item = {
  code: 'NIFTY IT', name: 'NIFTY IT', category: 'SECTORAL', engineSecurityId: 'INIDX0000180',
  ...
  rotation: { strength: 9, momentum: 3, zone: 'LEADING' },
...
beforeEach(() => {
  ...
  getIndices.mockReset(); getIndices.mockResolvedValue({
    ...
    activity: [{ eventId: 'event-1', activityType: 'QUADRANT', eventType: 'QUADRANT_ENTERED', effectiveDate: '2026-09-11', previousZone: null, newZone: 'LEADING', strength: 9, momentum: 3, index: { code: 'NIFTY IT', name: 'NIFTY IT', engineSecurityId: 'INIDX0000180' } }],
...
describe('IndicesPage', () => {
  ...
  it('plots indices in the quadrant and opens the index security view', async () => {
    ...
    expect(navigate).toHaveBeenCalledWith('/securities/INIDX0000180')
  })
})
