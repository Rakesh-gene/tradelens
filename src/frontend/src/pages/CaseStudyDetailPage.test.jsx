...
describe('CaseStudyDetailPage', () => {
  beforeEach(() => {
    getCaseStudy.mockResolvedValue({ caseStudy: {
      caseStudyId: '00000000-0000-0000-0000-000000000777', isin: 'INE002A01018', symbol: 'RELIANCE', patternType: 'REV-DBOT', state: 'TRIGGERED', detectionDate: '2025-01-02', entryDate: '2025-01-03', entryPrice: 100, setupScore: 80,
  ...
  it('centers the chart, entry rationale, and positional horizons instead of profit', async () => {
    ...
    expect(screen.getByRole('heading', { name: 'What is a double bottom?' })).not.toBeNull()
    expect(screen.getByText(/selling pressure is weakening/)).not.toBeNull()
