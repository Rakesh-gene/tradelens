...
describe('CaseStudiesPage', () => {
  beforeEach(() => {
    ...
    getCaseStudies.mockResolvedValue({
      ...
      items: [{
        ...
        patternType: 'BASE-VCP', timeframe: '1D', state: 'TRIGGERED', detectionDate: '2025-01-02', entryDate: '2025-01-03', entryPrice: 100,
  ...
  it('shows a browse-only tile/list catalog with clickable cases', async () => {
    ...
    expect(screen.getByText('volatility contraction pattern')).not.toBeNull()
