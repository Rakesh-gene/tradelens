...
const sector = { code: 'TECH', name: 'Technology', zone: 'LEADING', rs3m: 12, momentum: 3, coveredCount: 5, memberCount: 6, pairedCount: 4, isPartial: true }
beforeEach(() => {
...
describe('Sector rotation', () => {
  ...
  it('loads the selected sector and links ranked stocks to their fingerprint', async () => {
    ...
    expect((await screen.findByRole('link', { name: /RELIANCE/ })).getAttribute('href')).toBe('/securities/INE002A01018')
